...
if(pg_num_rows($result)>0)
{
	...
	{
        echo "<tr><td>" . $row[0]. "</td><td>" . $row[1]. "</td><td>" . $row[2]. "</td><td>" .$row[3]. "</td><td>" .$row[4]. "</td><td>" . $row[5]. "</td><td>" .$row[6]. "</td><td>" .$row[7]. "</td><td>" ."<a href='try.php?id=".$row[0]."'>Edit</a>" . "</td><td>". "<a href='delemp.php?id=".$row[0]."'>Delete</a>"."</td></tr>";
	}
	echo "</table>";
}
else
